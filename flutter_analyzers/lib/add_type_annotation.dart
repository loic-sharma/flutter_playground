...
class AddTypeAnnotation extends ResolvedCorrectionProducer {
  static const addTypeAnnotationAssist = AssistKind(
    'dart.assist.add.typeAnnotation',
    DartFixKindPriority.standard,
    'Add type annotation',
  );
  static const addTypeAnnotationFix = FixKind(
    'dart.fix.add.typeAnnotation',
    DartFixKindPriority.standard,
    'Add type annotation',
  );
  static const addTypeAnnotationMultiFix = FixKind(
  ...
  @override
  AssistKind get assistKind => addTypeAnnotationAssist;

  @override
  FixKind get fixKind => addTypeAnnotationFix;

  @override
  FixKind get multiFixKind => addTypeAnnotationMultiFix;
